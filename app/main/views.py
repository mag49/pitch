...
def index():
    ...
    bussinessplanpitch = Pitch.query.filter_by(category = "bussinessplanpitch")
    promotionpitch = Pitch.query.filter_by(category = "promotionpitch")

    upvotes = Upvote.get_all_upvotes(pitch_id=Pitch.id)
    

    return render_template('index.html', title = title, pitch = pitch, pickuplines=pickuplines, interviewpitch= interviewpitch,
...
def new_pitch():
    ...
    if form.validate_on_submit():
        ...
        new_pitch = Pitch(owner_id=owner_id,title = title,description=description,category=category)
